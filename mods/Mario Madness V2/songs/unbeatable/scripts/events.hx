...
function postCreate() {
    ...
    for (i in [ycbuLightningL = new FlxSprite(), ycbuLightningR = new FlxSprite()]) {
        i.frames = Paths.getSparrowAtlas('stages/HellishHights/nesbeat/ycbu_lightning');
    ...
    for (i in [ycbuHeadL = new FlxBackdrop(Paths.image('stages/HellishHights/nesbeat/YouCannotBeatUS_Fellas_Assets'), FlxAxes.Y, 0, 0), ycbuHeadR = new FlxBackdrop(Paths.image('stages/HellishHights/nesbeat/YouCannotBeatUS_Fellas_Assets'), FlxAxes.Y, 0, 0)]) {
        i.frames = Paths.getSparrowAtlas('stages/HellishHights/nesbeat/YouCannotBeatUS_Fellas_Assets');
    ...
    clownCar.frames = Paths.getSparrowAtlas("stages/HellishHights/nesbeat/Clown_Car");
    ...
    lakitu.frames = Paths.getSparrowAtlas("stages/HellishHights/nesbeat/YouCannotBeatUS_Fellas_Assets");
    ...
    gyromite.frames = Paths.getSparrowAtlas("stages/HellishHights/nesbeat/YouCannotBeatUS_Fellas_Assets");
...
function onEvent(_) {
    switch (_.event.name) {
        ...
        case "Hunter Duck":
            ...
            var duck:FlxSprite = new FlxSprite(250, 650).loadGraphic(Paths.image("stages/HellishHights/nesbeat/duck" + elpato));
            duck.frames = Paths.getSparrowAtlas("stages/HellishHights/nesbeatduck" + elpato);
        ...
        case "Bowser Podoboo":
            var podoboo:FlxSprite = new FlxSprite().loadGraphic(Paths.image('stages/HellishHights/nesbeat/fire'));
        ...
        case "Bowser Bullet":
            var bullet:FlxSprite = new FlxSprite().loadGraphic(Paths.image('stages/HellishHights/nesbeat/bullet'));
