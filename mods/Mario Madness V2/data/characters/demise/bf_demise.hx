...
function postCreate() {
	...
	leftArm = new FunkinSprite(0, 0, Paths.image('characters/HellishHights/mx/Demise_BF_Assets'));
    ...
    legs = new FunkinSprite(0, 0, Paths.image('characters/HellishHights/mx/Demise_BF_Assets'));
