...
function postCreate() {
	...
	leftArm = new FunkinSprite(0, 0, Paths.image('characters/HellishHights/mx/MX_Demise_Assets_Underground'));
    ...
    legs = new FunkinSprite(0, 0, Paths.image('characters/HellishHights/mx/MX_Demise_Assets_Underground'));
