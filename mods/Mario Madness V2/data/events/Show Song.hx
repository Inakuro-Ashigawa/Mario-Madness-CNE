...
function create(){
	...
	titleText.setFormat(Paths.font("mariones.ttf"), 42, FlxColor.BLACK, "center", FlxTextBorderStyle.OUTLINE);
	...
	autorText.setFormat(Paths.font("mariones.ttf"), 35, FlxColor.BLACK, "center", FlxTextBorderStyle.OUTLINE);
	...
	porterText.setFormat(Paths.font("mariones.ttf"), 22.5, FlxColor.BLACK, "center", FlxTextBorderStyle.OUTLINE);
